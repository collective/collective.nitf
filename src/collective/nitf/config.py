...
GENRES = SimpleVocabulary([
    ...
    SimpleTerm(value=u'Daybook',
               title=_(u'Daybook')),
    # Definition: Items filed on a regular basis that are lists of upcoming events with time and place, designed to inform others of events for planning purposes.
    SimpleTerm(value=u'Exclusive',
               title=_(u'Exclusive')),
    # Definition: Information content, in any form, that is unique to a specific information provider.
    SimpleTerm(value=u'Feature',
               title=_(u'Feature')),
    # Definition: The object content is about a particular event or individual that may not be significant to the current breaking news.
    ...
    SimpleTerm(value=u'Forecast',
               title=_(u'Forecast')),
    # Definition: The object contains opinion as to the outcome of a future event.
    ...
    SimpleTerm(value=u'History',
               title=_(u'History')),
    # Definition: The object content is based on previous rather than current events.
    SimpleTerm(value=u'Horoscope',
               title=_(u'Horoscope')),
    # Definition: Astrological forecasts
    SimpleTerm(value=u'Interview',
               title=_(u'Interview')),
    # Definition: The object contains a report of a dialogue with a news source that gives it significant voice (includes Q and A).
    SimpleTerm(value=u'Music',
               title=_(u'Music')),
    # Definition: The object contains music alone.
    SimpleTerm(value=u'Obituary',
               title=_(u'Obituary')),
    # Definition: The object contains a narrative about an individual's life and achievements for publication after his or her death.
    SimpleTerm(value=u'Opinion',
               title=_(u'Opinion')),
    # Definition: The object contains an editorial comment that reflects the views of the author.
    SimpleTerm(value=u'Polls and Surveys',
               title=_(u'Polls and Surveys')),
    # Definition: The object contains numeric or other information produced as a result of questionnaires or interviews.
    SimpleTerm(value=u'Press Release',
               title=_(u'Press Release')),
    # Definition: The object contains promotional material or information provided to a news organisation.
    SimpleTerm(value=u'Press-Digest',
               title=_(u'Press-Digest')),
    # Definition: The object contains an editorial comment by another medium completely or in parts without significant journalistic changes.
    SimpleTerm(value=u'Profile',
               title=_(u'Profile')),
    # Definition: The object contains a description of the life or activity of a news subject (often a living individual).
    SimpleTerm(value=u'Program',
               title=_(u'Program')),
    # Definition: A news item giving lists of intended events and time to be covered by the news provider. Each program covers a day, a week, a month or a year. The covered period is referenced as a keyword.
    SimpleTerm(value=u'Question and Answer Session',
               title=_(u'Question and Answer Session')),
    # Definition: The object contains the interviewer and subject questions and answers.
    SimpleTerm(value=u'Quote',
               title=_(u'Quote')),
    # Definition: The object contains a one or two sentence verbatim in direct quote.
    ...
    # Definition: The object contains alphanumeric data suitable for presentation in tabular form.
    SimpleTerm(value=u'Retrospective',
               title=_(u'Retrospective')),
    # Definition: The object contains material that looks back on a specific (generally long) period of time such as a season, quarter, year or decade.
    SimpleTerm(value=u'Review',
               title=_(u'Review')),
    # Definition: The object contains a critique of a creative activity or service (for example a book, a film or a restaurant).
    ...
    # Definition: The object contains a related story that provides additional insight into the news event being reported.
    SimpleTerm(value=u'Special Report',
               title=_(u'Special Report')),
    # Definition: In-depth examination of a single subject requiring extensive research and usually presented at great length, either as a single item or as a series of items.
    SimpleTerm(value=u'Summary',
               title=_(u'Summary')),
    # Definition: The object contains a single item synopsis of a number of news stories (generally unrelated).
    SimpleTerm(value=u'Synopsis',
               title=_(u'Synopsis')),
    # Definition: The object contains a condensed version of a single news item.
    ...
    # Definition: The object contains a word for word report of a discussion or briefing without significant journalistic intervention.
    SimpleTerm(value=u'Update',
               title=_(u'Update')),
    # Definition: The object contains an intraday snapshot (as for electronic services) of a single news subject.
    ...
    SimpleTerm(value=u'Wrapup',
               title=_(u'Wrapup')),
    # Definition: The object contains a recap of a running story (such as the end of the day).
    ])
