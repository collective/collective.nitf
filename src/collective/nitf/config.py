...
GENRES = SimpleVocabulary(
    [
        ...
        # planning purposes.
        SimpleTerm(value=u"Exclusive", title=_(u"Exclusive")),
        # Definition: Information content, in any form, that is unique to a
        # specific information provider.
        SimpleTerm(value=u"Feature", title=_(u"Feature")),
        ...
        SimpleTerm(value=u"Retrospective", title=_(u"Retrospective")),
        ...
        SimpleTerm(value=u"Special Report", title=_(u"Special Report")),
